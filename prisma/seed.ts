    ...
    data: [
      {
        ...
        address: "House No. 93, Block E, Youhanabad, Lahore, Pakistan",
        phone: "+92 307 8805989",
        email: ORG_EMAIL,
        hours: "Monday – Friday: 9:00 AM – 5:00 PM (PKT)",
        imageUrl: IMG.offices.southAsia,
        mapUrl: "https://www.google.com/maps/search/?api=1&query=House+No+93+Block+E+Youhanabad+Lahore+Pakistan",
        isHeadOffice: true,
        sortOrder: 0,
      },
      {
        ...
        imageUrl: IMG.offices.southAsia,
        mapUrl: "https://www.google.com/maps/search/?api=1&query=Gloria+Colony+Sheikhupura+Pakistan",
        sortOrder: 1,
      },
    ],
  });
